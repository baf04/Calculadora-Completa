...
public class ControladorCalculadoraSimple extends Stage implements Initializable {
        ...
        if (!operador.isEmpty()) {
            ...
            switch (operador) {
                ...
                case "/":
                    ...
                    break;
                case "^":
                    res = Math.pow(res, secondOperand);
                    break;
            }
            if((res-(int)res)!=0){
    ...
    @javafx.fxml.FXML
    public void clickExponente(ActionEvent actionEvent)
    {
        if (!numeroActual.equals("")) {
            calculationSetup("^");
        }
    ...
    @javafx.fxml.FXML
    public void clickCoseno(ActionEvent actionEvent) {
    ...
    @javafx.fxml.FXML
    public void clickSeno(ActionEvent actionEvent) {
        if (!numeroActual.isEmpty()) {
            double angle = Double.parseDouble(numeroActual);
    ...
    @javafx.fxml.FXML
    public void clickTangente(ActionEvent actionEvent) {
        if (!numeroActual.isEmpty()) {
            double angle = Double.parseDouble(numeroActual);
